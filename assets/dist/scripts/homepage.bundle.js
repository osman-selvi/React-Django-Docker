  ...
  _createClass(Global, [{
    ...
    value: function loadData() {
      ...
      fetch(url).then(function (response) {
        ...
        _this.appenData(data.results);
      });
    }
  }, {
    key: "appenData",
    value: function appenData(data) {
      // menu items
      var headerData = "\n      ".concat(data.map(function (item) {
        return "\n          <li><a href=\"syria.html\">".concat(item.title, "</a></li>\n        ");
      }).join(""), "\n    ");
...
var _GlobalSettings = _interopRequireDefault(require("./components/GlobalSettings"));
...
},{"./components/Footer":3,"./components/GlobalSettings":4,"./components/Header":5,"domready":1,"jquery":2}]},{},[6]);
